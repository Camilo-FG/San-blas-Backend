        ...
        public async Task<BautismoDto> CreateAsync(BautismoDto dto)
{
    var bautismo = new Bautismo
    {
        ...
        FechaBautismo = DateTime.SpecifyKind(DateTime.Parse(dto.FechaBautismo), DateTimeKind.Utc),
        AnnioBautismo = dto.AnnioBautismo,
        Prebispero = dto.Prebispero,
        FechaNacimiento = DateTime.SpecifyKind(DateTime.Parse(dto.FechaNacimiento), DateTimeKind.Utc),
       ...
       public async Task<BautismoDto?> UpdateAsync(int id, BautismoDto dto)
{
    ...
    bautismo.FechaBautismo = DateTime.SpecifyKind(DateTime.Parse(dto.FechaBautismo), DateTimeKind.Utc);
    bautismo.AnnioBautismo = dto.AnnioBautismo;
    bautismo.Prebispero = dto.Prebispero;
    bautismo.FechaNacimiento = DateTime.SpecifyKind(DateTime.Parse(dto.FechaNacimiento), DateTimeKind.Utc);
